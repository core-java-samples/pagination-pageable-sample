...
record Pageable(int page, int size) {}
...
public class PaginationPageableApplication {

    public static void main(String[] args) {
        SpringApplication.run(PaginationPageableApplication.class, args);
        new PaginationPageableApplication().demo();
    }
    void demo() {

        OwnerRepository repository = new FakeOwnerRepository();

        System.out.println(repository.findAll(new Pageable(0, 2)));
        System.out.println(repository.findAll(new Pageable(1, 2)));
        System.out.println(repository.findAll(new Pageable(2, 2)));
    }
}
